 ...
 * Brighter lines for better visibility against the dark background.
 */
class GridGeometry {
    ...
    fun draw(shader: ShaderProgram, vpMatrix: FloatArray) {
        ...
        // Bright frame — pillars + top
        GLES20.glLineWidth(2.0f)
        shader.setUniform4f("uColor", 1f, 1f, 1f, 0.35f)
        ...
        shader.setUniform4f("uColor", 1f, 1f, 1f, 0.18f)
